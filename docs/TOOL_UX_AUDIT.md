...
4. **Image canvas tools:** Resize, Crop, Photo Editor, Upscale, Remove Background, Watermark, and Meme live previews are complete; continue with Rotate and Blur Face.
