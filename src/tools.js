...
export const tools = withPhosphorExports([
  ...
  },
  {
    slug: "blur-face",
    name: "Blur Face",
    description: "Detect supported faces locally or position a manual privacy area.",
    kind: "image",
    category: "security",
    accepts: [".jpg", ".jpeg", ".png", ".webp"],
    output: [".jpg", ".png", ".webp"],
    ...
    settings: [
      ...
      },
      {
        key: "focusX",
        type: "range",
        label: "Fallback horizontal position",
        default: 50,
        min: 10,
        max: 90,
        step: 1,
      ...
      },
      {
        key: "focusY",
        type: "range",
        label: "Fallback vertical position",
        default: 35,
        min: 10,
        max: 90,
        step: 1,
      ...
      },
      {
        key: "regionSize",
        type: "range",
        label: "Manual privacy-area size",
        default: 34,
        min: 18,
        max: 64,
        step: 2,
